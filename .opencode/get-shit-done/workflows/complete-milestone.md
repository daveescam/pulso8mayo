...
```bash
node "C:/Users/david/pulso29/.opencode/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `C:/Users/david/pulso29/.opencode/get-shit-done/templates/retrospective.md`.
