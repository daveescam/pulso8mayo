...
```bash
INIT=$(node "C:/Users/david/pulso29/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/david/pulso29/.opencode/get-shit-done/templates/spec.md.
