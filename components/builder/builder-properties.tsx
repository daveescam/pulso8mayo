            ...
            <Tabs defaultValue="general" className="flex-1 overflow-hidden flex flex-col">
                <div className="px-4 pt-2">
                    <TabsList className="w-full">
                        ...
                        {(selectedElement.type === "Photo" || selectedElement.type === "Temperature") && (
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-6">
                    <TabsContent value="general" className="space-y-4 mt-0">
                        ...
                        {selectedElement.type !== "Heading" && selectedElement.type !== "Checkbox" && selectedElement.type !== "Switch" && (
                            <div className="space-y-2">
                        ...
                        {selectedElement.type === "Heading" && (
                            <div className="p-3 bg-muted/50 rounded-md text-sm text-muted-foreground">
                                Los encabezados sirven para separar secciones en tu formulario.
                            </div>
                        )}
                    </TabsContent>
                    ...
                    <TabsContent value="validation" className="space-y-4 mt-0">
                        ...
                        {(selectedElement.type === "Input" || selectedElement.type === "Temperature") && (
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => updateElement(selectedElement.id, { min: parseFloat(e.target.value) })}
                                    />
                                </div>
                                <div className="space-y-2">
                                    <Label>Máximo</Label>
                                    <Input
                                        ...
                                        onChange={(e) => updateElement(selectedElement.id, { max: parseFloat(e.target.value) })}
                                    />
                                </div>
                            </div>
                        )}
                    ...
                    <TabsContent value="advanced" className="space-y-6 mt-0">
                        {selectedElement.type === "Photo" && (
                            <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Switch
                                        checked={selectedElement.aiVerification || false}
                                        onCheckedChange={(checked) => updateElement(selectedElement.id, { aiVerification: checked })}
                                    />
                                </div>

                                {selectedElement.aiVerification && (
                        ...
                        {selectedElement.type === "Temperature" && (
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <Label>Unidad de Medida</Label>
                                    <Select
                                        value={selectedElement.unit || 'C'}
                                        onValueChange={(val) => updateElement(selectedElement.id, { unit: val })}
                                    >
                                        <SelectTrigger>
                                            <SelectValue />
                                        </SelectTrigger>
